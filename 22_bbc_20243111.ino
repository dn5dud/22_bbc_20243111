...
#define _DUTY_MAX 2130 // 2000
#define _DUTY_NEU 1550 // 1500
#define _DUTY_MIN 597 // 1000

#define _SERVO_ANGLE_DIFF  134  // Replace with |D - E| degree
...
float volt_to_distance(int a_value)
{
  ...
  return 634 -2.48*a_value + 3.23E-03*a_value*a_value -1.41E-06*a_value*a_value*a_value;
}
